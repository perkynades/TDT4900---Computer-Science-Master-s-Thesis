...
\begin{itemize}
    ...
    \item Se om det er noe overalapp mellom "Resources" og "Project"
    \item Se om det er noe overlapp mellom "Feedback" og "Agile methods"
    \item Se på overlapp mellom "User" og "Agile methods"
    \item Se hva i "context" som kan plasseres andre steder
    \item Se om noe i "revision" skal i "project"
    \item Se om det er overlapp mellom "Domain" og "Resources"
\end{itemize}
}
...
\section{User}
\textit{Participant \#2} explaining that software quality could be that the user feel value in the software, that the software is good.
...
\textit{Participant \#7} explaining that at NRK there was still a lot projects, with the focus on external revisions or performing quality assurance of the projects. However this did little to actually assure quality in the project.
