...
\textcolor{red}{Skal jeg være litt mer spesifik her, som hvilke stillinger de hadde osv?}
...
\hline
\textbf{Sections} & \textbf{Category} \\ \hline
...
To categorise which themes are shared between interviews, a table of interconnected themes between interviews is created \cite{bjo_2022}. \autoref{tab:example_interconnected_themes} is an example of this. 

\textcolor{red}{Her må den faktiske tabellen bli satt inn}

\begin{table}[h]
\centering
\begin{tabular}{|l|l|l|l|l|}
\hline
\textbf{Interview date / Theme} & 1.1.22 & 2.1.22 & 4.1.22 & 6.1.22\\ \hline
Technical testing & *      & *      &        & *      \\ \hline
Culture           & *      &        & *      & *      \\ \hline
\end{tabular}
\caption{Example table of interconnected themes between interviews}
\label{tab:example_interconnected_themes}
\end{table}
